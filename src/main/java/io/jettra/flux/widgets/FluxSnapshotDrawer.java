...
public class FluxSnapshotDrawer extends Widget {
    ...
    public String render(ThemeData theme) {
        ...
        sb.append("<div id=\"").append(drawerId).append("\" class=\"jettra-snapshot-drawer\" style=\"position:fixed; top:0; right:0; bottom:0; width:100%; max-width:").append(width).append("; background:var(--j-bg-surface, #0f172a); border-left:1px solid var(--j-border, #334155); box-shadow:-8px 0 24px rgba(0,0,0,0.5); z-index:999999; transform:translateX(100%); transition:transform 0.25s cubic-bezier(0.4, 0, 0.2, 1); display:flex; flex-direction:column;\">");
